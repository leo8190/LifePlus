		...
		<div id="contenedor">
			...
			<form method="post" action="">
				...
				<div class="div_in"><label for="n">Nombre:</label>
					<input class="form-control form-control-sm" id="n" type="text" name="nombre" disable value="<?=$u['nombre']?>"></input>
				</div>

				<div class="div_in"><label for="a">Apellido:</label>
					<input  class="form-control form-control-sm" id="a"type="text" name="apellido" disable value="<?=$u['apellido']?>"></input>
				</div>

				<div class="div_in"><label for="e">E-Mail:</label>
					<input class="form-control form-control-sm" id="e"type="text" name="email" disable  value="<?=$u['email']?>"></input>
				</div>
				<br/><br/>
				<div class="div_in"><label for="nu">Nombre de usuario:</label>
					<input class="form-control form-control-sm"  id="nu"type="text" disable name="nombre_usuario" value="<?=$u['nombre_usuario']?>"></input>
				</div>	

				<div class="div_in"><label for="dni">Dni</label>
					<input  class="form-control form-control-sm" id="dni"type="text" disable name="dni" value="<?=$u['dni']?>"></input>
				</div>

				<div class="div_in"><label for="nu">Password:</label>
					<input  class="form-control form-control-sm" id="p"type="text" name="password" disable value="<?=$u['password']?>"></input>
				</div>

				<br/><br/>

				<div class="div_in"><label for="n">Teléfono:</label>
					<input class="form-control form-control-sm" id="t"type="text" disable name="telefono" value="<?=$u['telefono']?>"></input>
				</div>
				...
				<select class="form-control form-control-sm" id="agencia" name="id_agencia"  style="width: 200px;" onchange="cambia()">
				...
				<select class="form-control form-control-sm" id="rol" name="id_rol" style="width: 200px;" onchange="cambia()">
				...
				<select class="form-control form-control-sm" id="estado" name="id_estado" style="width: 200px;" onchange="cambia()">
